...
public class Lang_1_Activity extends AppCompatActivity {
    ...
    String[] strArray = {"exp_vids/lang_1_1.webm", "exp_vids/lang_1_2.webm", "exp_vids/lang_1_3.webm", "exp_vids/lang_1_4.webm", "exp_vids/lang_1_5.webm", "exp_vids/lang_1_6.webm",
            "exp_vids/lang_1_7.webm", "exp_vids/lang_1_8.webm", "exp_vids/lang_1_9.webm", "exp_vids/lang_1_10.webm", "exp_vids/lang_1_11.webm", "exp_vids/lang_1_12.webm"};
    ProgressDialog progressDoalog1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lang_1);
...
//        String path = "android.resource://" + getPackageName() + "/" + R.raw.lang_1_1;
//
...
//        vv.setMediaController(null);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Lang_1_Activity.this, iv_back);
                stopvid();
                finish();
            }
        });
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_1_Activity.this, iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Lang_1_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_1_Activity.this, iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_1_Activity.this, iv_next);
                position += 1;
                   ...
                   checkfileexists();
                    ...
                    vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            Toast.makeText(Lang_1_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
//                            stopvid();
//                            Intent i = new Intent(Lang_1_Activity.this, Quiz1Activity.class);
//                            startActivity(i);
                            //finish();
                        }
                    });
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_1_Activity.this, iv_home);
                Intent i1 = new Intent(Lang_1_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
        ...
        imgbtn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Lang_1_Activity.this, imgbtn_prev);
                    if (position > 0) {
//                    stopvid();
                        position -= 1;
                       checkfileexists();
        ...
        imgbtn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Lang_1_Activity.this, imgbtn_home);
                    stopvid();
                    finish();
                }
            }
        ...
        btn_key_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_a);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        });
        btn_key_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_b);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_c);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_d);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_e.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_e);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_f);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_g.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_g);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_h.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_h);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_i);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_j);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_k.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_k);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_l);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_m);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_n);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_o);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_p);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_q);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_r);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_s);
...
//                        stopvid();
        ...
        btn_key_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_t);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_u.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_u);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_v);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_w.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_w);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_x);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_y.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_y);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_z.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Lang_1_Activity.this, btn_key_z);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Lang_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
...
//        vv.setVideoPath("http://techslides.com/demos/sample-videos/small.webm");
        vv.setVideoURI(listURI.get(pos));
//        vv.setVideoURI(urilist.get(pos));
        MediaController mediaController = new MediaController(this);
        mediaController.setAnchorView(vv);
        vv.setMediaController(mediaController);
        ...
        if (position == 1 || position == 3 || position == 7 || position == 9) {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mediaPlayer) {
                    image_anim_last(Lang_1_Activity.this, iv_next);
                    iv_playpause.setImageResource(R.drawable.ic_play);
                }
            });
        }
        ...
        if(position==strArray.length-1)
        {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mediaPlayer) {
                    ...
                    tv_lastpage_text.setText("You Completed Language Lesson 1");
                    ib_home.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            StaticValues.SavePreferences("Lang_1_Activity","YES", Lang_1_Activity.this);
                            Intent intent = new Intent(Lang_1_Activity.this, Letter_XYZ_Activity.class);
    ...
    public void checkfileexists() {
            if (StaticValues.GetPreferences("Last_Open_position", Lang_1_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Lang_1_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Lang_1_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Lang_1_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Lang_1_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Lang_1_Activity", Lang_1_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Langs", Lang_1_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Lang_1_Activity.this);
    }
    @Override
