...
public class Lang_8_Activity extends AppCompatActivity {
    ...
    String[] strArray = {"exp_vids/lang_8_1.webm", "exp_vids/lang_8_2.webm", "exp_vids/lang_8_3.webm", "exp_vids/lang_8_4.webm", "exp_vids/lang_8_5.webm", "exp_vids/lang_8_6.webm",
            "exp_vids/lang_8_7.webm", "exp_vids/lang_8_8.webm", "exp_vids/lang_8_9.webm", "exp_vids/lang_8_10.webm", "exp_vids/lang_8_11.webm", "exp_vids/lang_8_12.webm","exp_vids/lang_8_13.webm",
            "exp_vids/lang_8_14.webm","exp_vids/lang_8_15.webm","exp_vids/lang_8_16.webm","exp_vids/lang_8_17.webm","exp_vids/lang_8_18.webm","exp_vids/lang_8_19.webm","exp_vids/lang_8_20.webm",
            "exp_vids/lang_8_21.webm","exp_vids/lang_8_22.webm","exp_vids/lang_8_23.webm"};
    private ProgressDialog progressDoalog1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lang_8);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Lang_8_Activity.this,iv_back);
                stopvid();
                finish();
            }
        });
        ...
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_8_Activity.this,iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Lang_8_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_8_Activity.this,iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_8_Activity.this,iv_next);
                position += 1;
                   ...
                   checkfileexists();
                    ...
                    vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            Toast.makeText(Lang_8_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
//                            stopvid();
//                            Intent i = new Intent(Lang_8_Activity.this, Quiz1Activity.class);
//                            startActivity(i);
                            //finish();
                        }
                    });
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_8_Activity.this,iv_home);
                Intent i1 = new Intent(Lang_8_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
...
//        vv.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + urilist.get(pos)));
        ...
        if(position>=6)
        {
            ...
            dict_click_v1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!vv.isPlaying()) {
                        View_anim(Lang_8_Activity.this,dict_click_v1);
                        if (position == 7||position == 9||position == 11||position == 13||position == 14||position == 16
...
//                        stopvid();
                            ...
                            MediaPlayer mPlayer2 = MediaPlayer.create(Lang_8_Activity.this, R.raw.tryagain);
                            mPlayer2.start();
                        }
                    }
            ...
            dict_click_v3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!vv.isPlaying()) {
                        View_anim(Lang_8_Activity.this,dict_click_v3);
                        if (position == 6||position == 8||position == 10||position == 12||position == 15||position == 17
...
//                        stopvid();
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mediaPlayer) {
                    image_anim_last(Lang_8_Activity.this,iv_next);
                    iv_playpause.setImageResource(R.drawable.ic_play);
                }
            });
        }
        ...
        if(position==strArray.length-1)
        {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mediaPlayer) {
                    ...
                    tv_lastpage_text.setText("You Completed Language Lesson 8");
                    ib_home.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            StaticValues.SavePreferences("Lang_8_Activity","YES", Lang_8_Activity.this);
                            Intent intent = new Intent(Lang_8_Activity.this, Spell_8_Activity.class);
    ...
    public void checkfileexists() {
            if (StaticValues.GetPreferences("Last_Open_position", Lang_8_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Lang_8_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Lang_8_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Lang_8_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Lang_8_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Lang_8_Activity", Lang_8_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Langs", Lang_8_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Lang_8_Activity.this);
    }
    @Override
