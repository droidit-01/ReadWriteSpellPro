...
public class Lang_24_Activity extends AppCompatActivity {
    ...
    String[] strArray = {"exp_vids/lang_24_1.webm", "exp_vids/lang_24_2_cl.webm", "exp_vids/lang_24_3.webm", "exp_vids/lang_24_4_cl.webm", "exp_vids/lang_24_5_cl.webm", "exp_vids/lang_24_6.webm",
            "exp_vids/lang_24_7_cl.webm", "exp_vids/lang_24_8_cl.webm", "exp_vids/lang_24_9.webm", "exp_vids/lang_24_10_cl.webm", "exp_vids/lang_24_11_cl.webm", "exp_vids/lang_24_12.webm"};
    private ProgressDialog progressDoalog1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lang_24);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Lang_24_Activity.this,iv_back);
                stopvid();
                finish();
            }
        });
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_24_Activity.this,iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Lang_24_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_24_Activity.this,iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_24_Activity.this,iv_next);
                position += 1;
                   ...
                   checkfileexists();
                    ...
                    vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            Toast.makeText(Lang_24_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
//                            stopvid();
//                            Intent i = new Intent(Lang_24_Activity.this, Quiz1Activity.class);
//                            startActivity(i);
                            //finish();
                        }
                    });
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_24_Activity.this,iv_home);
                Intent i1 = new Intent(Lang_24_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
...
//                        stopvid();
                        ...
                        MediaPlayer mPlayer2 = MediaPlayer.create(Lang_24_Activity.this, R.raw.tryagain);
                        mPlayer2.start();
                    }
                }
            }
...
//        vv.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + urilist.get(pos)));
        ...
        if (position == 1 || position == 3|| position == 4|| position == 6||position==7||position==9||position==10)
        {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mediaPlayer) {
                    image_anim_last(Lang_24_Activity.this,iv_next);
                    iv_playpause.setImageResource(R.drawable.ic_play);
                }
            });
        }
        ...
        if(position==strArray.length-1)
        {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mediaPlayer) {
                    ...
                    tv_lastpage_text.setText("You Completed Language Lesson 24");
                    ib_home.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            StaticValues.SavePreferences("Lang_24_Activity","YES", Lang_24_Activity.this);
                            Intent intent = new Intent(Lang_24_Activity.this, Dict_17_Activity.class);
    ...
    public void checkfileexists() {
            if (StaticValues.GetPreferences("Last_Open_position", Lang_24_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Lang_24_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Lang_24_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Lang_24_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Lang_24_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Lang_24_Activity", Lang_24_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Langs", Lang_24_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Lang_24_Activity.this);
    }
    @Override
