...
public class Lang_2_Activity extends AppCompatActivity {
    ...
    String[] strArray = {"exp_vids/lang_2_1.webm", "exp_vids/lang_2_2.webm", "exp_vids/lang_2_3.webm", "exp_vids/lang_2_4.webm", "exp_vids/lang_2_5.webm", "exp_vids/lang_2_6.webm"};
    ProgressDialog progressDoalog1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lang_2);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Lang_2_Activity.this,iv_back);
                stopvid();
                //finish();
            }
        });
        ...
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_2_Activity.this,iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Lang_2_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_2_Activity.this,iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_2_Activity.this,iv_next);
                position += 1;
                   ...
                   checkfileexists();
                    ...
                    vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            Toast.makeText(Lang_2_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
//                            stopvid();
//                            Intent i = new Intent(Lang_2_Activity.this, Quiz1Activity.class);
//                            startActivity(i);
                            //finish();
                        }
                    });
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Lang_2_Activity.this,iv_home);
                Intent i1 = new Intent(Lang_2_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
...
//        vv.setVideoURI(urilist.get(pos));
        ...
        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
                image_anim_last(Lang_2_Activity.this,iv_next);
                iv_playpause.setImageResource(R.drawable.ic_play);
            }
        });
                ...
                public void onCompletion(MediaPlayer mediaPlayer) {
                    ...
                    ib_home.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            StaticValues.SavePreferences("Lang_2_Activity","YES", Lang_2_Activity.this);
                            Intent intent = new Intent(Lang_2_Activity.this, Reading_Chapt7_Activity.class);
    ...
    public void checkfileexists() {
            if (StaticValues.GetPreferences("Last_Open_position", Lang_2_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Lang_2_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Lang_2_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Lang_2_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Lang_2_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Lang_2_Activity", Lang_2_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Langs", Lang_2_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Lang_2_Activity.this);
    }
    @Override
