...
public class Dict_6_Activity extends AppCompatActivity {
    VideoView vv;
    ...
    View clickview;
    String[] strArray = {"exp_vids/dict_6_1.webm", "exp_vids/dict_6_2.webm", "exp_vids/dict_6_3.webm", "exp_vids/dict_6_4.webm", "exp_vids/dict_6_5.webm", "exp_vids/dict_6_6.webm",
            "exp_vids/dict_6_7.webm", "exp_vids/dict_6_8.webm", "exp_vids/dict_6_9.webm", "exp_vids/dict_6_10.webm"};
    private ProgressDialog progressDoalog1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dict_6);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Dict_6_Activity.this,iv_back);
                stopvid();
                finish();
            }
        });
        ...
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_6_Activity.this,iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Dict_6_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_6_Activity.this,iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_6_Activity.this,iv_next);
                position += 1;
                    ...
                    if(position==strArray.length-1)
                    {
                        ...
                        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                tv_lastpage_text.setText("You Completed Dictionary Lesson 6");
                                ib_home.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        StaticValues.SavePreferences("Dict_6_Activity","YES",Dict_6_Activity.this);
                                        Intent intent = new Intent(Dict_6_Activity.this, Lang_10_Activity.class);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_6_Activity.this,iv_home);
                Intent i1 = new Intent(Dict_6_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
...
//        vv.setVideoURI(urilist.get(pos));
        ...
        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
                image_anim_last(Dict_6_Activity.this,iv_next);
                iv_playpause.setImageResource(R.drawable.ic_play);
            }
        });
//        if (position==4)
...
//        });
    ...
    public void checkfileexists() {
            if (StaticValues.GetPreferences("Last_Open_position", Dict_6_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Dict_6_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Dict_6_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Dict_6_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Dict_6_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Dict_6_Activity", Dict_6_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Dictionary", Dict_6_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Dict_6_Activity.this);
    }
    @Override
