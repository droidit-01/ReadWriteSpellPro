...
public class Dict_10_Activity extends AppCompatActivity {
    ...
    View clickview;
    String[] strArray = {"exp_vids/dict_10_1.webm", "exp_vids/dict_10_2.webm", "exp_vids/dict_10_3.webm", "exp_vids/dict_10_4.webm", "exp_vids/dict_10_5.webm", "exp_vids/dict_10_6.webm",
            "exp_vids/dict_10_7.webm", "exp_vids/dict_10_8.webm", "exp_vids/dict_10_9.webm", "exp_vids/dict_10_10.webm", "exp_vids/dict_10_11.webm", "exp_vids/dict_10_12.webm","exp_vids/dict_10_13.webm",
            "exp_vids/dict_10_14.webm","exp_vids/dict_10_15.webm","exp_vids/dict_10_16.webm","exp_vids/dict_10_17.webm","exp_vids/dict_10_18.webm","exp_vids/dict_10_19.webm","exp_vids/dict_10_20.webm",
            "exp_vids/dict_10_21.webm","exp_vids/dict_10_22.webm","exp_vids/dict_10_23.webm","exp_vids/dict_10_24.webm","exp_vids/dict_10_25.webm","exp_vids/dict_10_26.webm","exp_vids/dict_10_27.webm",
            "exp_vids/dict_10_28.webm","exp_vids/dict_10_29.webm","exp_vids/dict_10_30.webm","exp_vids/dict_10_31.webm","exp_vids/dict_10_32.webm","exp_vids/dict_10_33.webm","exp_vids/dict_10_34.webm"};
    private ProgressDialog progressDoalog1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dict_10);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Dict_10_Activity.this,iv_back);
                stopvid();
                finish();
            }
        });
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_10_Activity.this,iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Dict_10_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_10_Activity.this,iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_10_Activity.this,iv_next);
                position += 1;
                    ...
                    if(position==strArray.length-1)
                    {
                        ...
                        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                tv_lastpage_text.setText("You Completed Dictionary Lesson 10");
                                ib_home.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        StaticValues.SavePreferences("Dict_10_Activity","YES",Dict_10_Activity.this);
                                        Intent intent = new Intent(Dict_10_Activity.this, Lang_15_Activity.class);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_10_Activity.this,iv_home);
                Intent i1 = new Intent(Dict_10_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
        ...
        imgbtn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Dict_10_Activity.this,imgbtn_prev);
                    if (position > 0) {
//                    stopvid();
                        position -= 1;
                       checkfileexists();
        ...
        imgbtn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Dict_10_Activity.this,imgbtn_home);
                    stopvid();
                    //finish();
                }
            }
        ...
        btn_key_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_a);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        });
        btn_key_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_b);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_c);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_d);
                    if (position == 1) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                           checkfileexists();
                            ...
                            position -= 1;
                            Toast.makeText(Dict_10_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
                            stopvid();
                            Intent i = new Intent(Dict_10_Activity.this, Quiz1Activity.class);
                            startActivity(i);
                            //finish();
                        }
                    } else {
        ...
        btn_key_e.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_e);
                    if (position == 32) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_f);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_g.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_g);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_h.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_h);
                    if (position == 6) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_i);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_j);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_k.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_k);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_l);
                    if (position == 29) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_m);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_n);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_o);
                    if (position == 2||position == 7||position == 12||position == 17||position == 21||position == 22||position == 30) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_p);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_q);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_r);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_s);
                    if (position == 31) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_t);
                    if (position == 11||position == 15||position == 20) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_u.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_u);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_v);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_w.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_w);
...
//                        stopvid();
        ...
        btn_key_x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_x);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_y.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_y);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_z.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_10_Activity.this,btn_key_z);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_10_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
    ...
    private void initializePlayer(int pos, List<Uri> urilist, List<String> mysound_list) {
        ...
        if (position == 32||position == 31||position == 1||position == 2||position == 7||position == 12||position == 17||position == 21
                ||position == 22||position == 30||position == 5||position == 16||position == 6||position == 11||position == 15
                ||position == 20||position == 29)
        {
...
//            }
//        });
        if(position==0||position == 4||position == 9||position == 14||position == 19||position == 28)
        {
            clickview.setVisibility(View.VISIBLE);
            layout_dictgame.setVisibility(View.GONE);
...
//            iv_next.setEnabled(false);
            ...
            dict_click_v1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!vv.isPlaying()) {
                        View_anim(Dict_10_Activity.this,dict_click_v1);
                        if (position == 26) {
                            position += 1;
                            if (position <= strArray.length - 1) {
//                        stopvid();
            ...
            dict_click_v2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!vv.isPlaying()) {
                        View_anim(Dict_10_Activity.this,dict_click_v2);
                        if (position == 24) {
                            position += 1;
                            if (position <= strArray.length - 1) {
//                        stopvid();
            ...
            dict_click_v3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!vv.isPlaying()) {
                        View_anim(Dict_10_Activity.this,dict_click_v3);
                        if (position ==25) {
                            position += 1;
                            if (position <= strArray.length - 1) {
//                        stopvid();
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mediaPlayer) {
                    image_anim_last(Dict_10_Activity.this,iv_next);
                    iv_playpause.setImageResource(R.drawable.ic_play);
                }
            });
        }
    ...
    public void checkfileexists() {
            ...
            if (StaticValues.GetPreferences("Last_Open_position", Dict_10_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Dict_10_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Dict_10_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Dict_10_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Dict_10_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Dict_10_Activity", Dict_10_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Dictionary", Dict_10_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Dict_10_Activity.this);
    }
    @Override
