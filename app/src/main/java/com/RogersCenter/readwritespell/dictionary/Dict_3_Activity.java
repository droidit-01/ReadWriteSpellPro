...
public class Dict_3_Activity extends AppCompatActivity {
    ...
    View clickview;
    String[] strArray = {"exp_vids/dict_3_1.webm", "exp_vids/dict_3_2.webm", "exp_vids/dict_3_3.webm", "exp_vids/dict_3_4.webm", "exp_vids/dict_3_5.webm", "exp_vids/dict_3_6.webm",
            "exp_vids/dict_3_7.webm", "exp_vids/dict_3_8.webm", "exp_vids/dict_3_9.webm", "exp_vids/dict_3_10.webm", "exp_vids/dict_3_11.webm", "exp_vids/dict_3_12.webm","exp_vids/dict_3_13.webm",
            "exp_vids/dict_3_14.webm","exp_vids/dict_3_15.webm","exp_vids/dict_3_16.webm","exp_vids/dict_3_17.webm","exp_vids/dict_3_18.webm","exp_vids/dict_3_19.webm","exp_vids/dict_3_20.webm",
            "exp_vids/dict_3_21.webm","exp_vids/dict_3_22.webm","exp_vids/dict_3_23.webm","exp_vids/dict_3_24.webm","exp_vids/dict_3_25.webm","exp_vids/dict_3_26.webm","exp_vids/dict_3_27.webm",
            "exp_vids/dict_3_28.webm","exp_vids/dict_3_29.webm","exp_vids/dict_3_30.webm","exp_vids/dict_3_31.webm","exp_vids/dict_3_32.webm","exp_vids/dict_3_33.webm","exp_vids/dict_3_34.webm",
            "exp_vids/dict_3_35.webm","exp_vids/dict_3_36.webm","exp_vids/dict_3_37.webm","exp_vids/dict_3_38.webm","exp_vids/dict_3_39.webm","exp_vids/dict_3_40.webm","exp_vids/dict_3_41.webm",
            "exp_vids/dict_3_42.webm","exp_vids/dict_3_43.webm","exp_vids/dict_3_44.webm","exp_vids/dict_3_45.webm"};
    private ProgressDialog progressDoalog1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dict_3);
 ...
 iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Dict_3_Activity.this,iv_back);
                stopvid();
                finish();
            }
        });
        ...
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_3_Activity.this,iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Dict_3_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_3_Activity.this,iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_3_Activity.this,iv_next);
                position += 1;
                    ...
                    if(position==strArray.length-1)
                    {
                        ...
                        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                tv_lastpage_text.setText("You Completed Dictionary Lesson 3");
                                ib_home.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        StaticValues.SavePreferences("Dict_3_Activity","YES",Dict_3_Activity.this);
                                        Intent intent = new Intent(Dict_3_Activity.this, Lang_8_Activity.class);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_3_Activity.this,iv_home);
                Intent i1 = new Intent(Dict_3_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
        ...
        imgbtn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Dict_3_Activity.this,imgbtn_prev);
                    if (position > 0) {
//                    stopvid();
                        position -= 1;
                       checkfileexists();
        ...
        imgbtn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Dict_3_Activity.this,imgbtn_home);
                    stopvid();
                    finish();
                }
            }
        ...
        btn_key_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_a);
...
//                        stopvid();
                           checkfileexists();
                            ...
                            position -= 1;
                            Toast.makeText(Dict_3_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
                            stopvid();
                            Intent i = new Intent(Dict_3_Activity.this, Quiz1Activity.class);
                            startActivity(i);
                            //finish();
                        }
                    } else {
                        MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                        mPlayer2.start();
                    }
                }
            }
        ...
        btn_key_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_b);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_c);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_d);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_e.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_e);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_f);
                    if (position == 27||position == 28||position == 33) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_g.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_g);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_h.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_h);
                    if (position == 37) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_i);
                    if (position == 38||position == 42) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_j);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_k.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_k);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    if (!vv.isPlaying()) {
                        keyboard_button_anim(Dict_3_Activity.this,btn_key_l);
                        if (position == 4||position == 5||position == 10||position == 11||position == 16||position == 17||
...
//                        stopvid();
        ...
        btn_key_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_m);
                    if (position == 8) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_n);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_o);
...
//                        stopvid();
        ...
        btn_key_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_p);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_q);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_r);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_s);
                    if (position == 39||position == 43) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_t);
                    if (position == 14) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_u.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_u);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_v);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_w.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_w);
                    if (position == 20) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_x);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_y.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_y);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_z.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_3_Activity.this,btn_key_z);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_3_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
    ...
    private void initializePlayer(int pos, List<Uri> urilist, List<String> mysound_list) {
        ...
        if (position == 3||position == 4||position == 5||position == 8||position == 9||position == 10||position == 11
                ||position == 14||position == 15||position == 16||position == 17||position == 20||position == 21||position == 22||position == 23
                ||position == 26||position == 27||position == 28||position == 32||position == 33||position == 37||position == 38||position == 39
...
//            }
//        });
        if(position==2||position==7||position==13||position==19||position==25||position==31||position==36||position==41)
        {
...
//                            startActivity(i);
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mediaPlayer) {
                    image_anim_last(Dict_3_Activity.this,iv_next);
                    iv_playpause.setImageResource(R.drawable.ic_play);
                }
            });
        }
    ...
    public void checkfileexists() {
            if (StaticValues.GetPreferences("Last_Open_position", Dict_3_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Dict_3_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Dict_3_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Dict_3_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Dict_3_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Dict_3_Activity", Dict_3_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Dictionary", Dict_3_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Dict_3_Activity.this);
    }
    @Override
