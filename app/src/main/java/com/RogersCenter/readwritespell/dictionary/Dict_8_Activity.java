...
public class Dict_8_Activity extends AppCompatActivity {
    ...
    String[] strArray = {"exp_vids/dict_8_1.webm", "exp_vids/dict_8_2.webm", "exp_vids/dict_8_3.webm", "exp_vids/dict_8_4.webm", "exp_vids/dict_8_5.webm", "exp_vids/dict_8_6.webm",
            "exp_vids/dict_8_7.webm", "exp_vids/dict_8_8.webm", "exp_vids/dict_8_9.webm", "exp_vids/dict_8_10.webm", "exp_vids/dict_8_11.webm", "exp_vids/dict_8_12.webm","exp_vids/dict_8_13.webm",
            "exp_vids/dict_8_14.webm","exp_vids/dict_8_15.webm","exp_vids/dict_8_16.webm","exp_vids/dict_8_17.webm","exp_vids/dict_8_18.webm","exp_vids/dict_8_19.webm","exp_vids/dict_8_20.webm",
            "exp_vids/dict_8_21.webm","exp_vids/dict_8_22.webm","exp_vids/dict_8_23.webm","exp_vids/dict_8_24.webm","exp_vids/dict_8_25.webm","exp_vids/dict_8_26.webm","exp_vids/dict_8_27.webm",
            "exp_vids/dict_8_28.webm","exp_vids/dict_8_29.webm","exp_vids/dict_8_30.webm","exp_vids/dict_8_31.webm","exp_vids/dict_8_32.webm","exp_vids/dict_8_33.webm","exp_vids/dict_8_34.webm",
            "exp_vids/dict_8_35.webm","exp_vids/dict_8_36.webm","exp_vids/dict_8_37.webm","exp_vids/dict_8_38.webm","exp_vids/dict_8_39.webm","exp_vids/dict_8_40.webm","exp_vids/dict_8_41.webm",
            "exp_vids/dict_8_42.webm","exp_vids/dict_8_43.webm","exp_vids/dict_8_44.webm","exp_vids/dict_8_45.webm","exp_vids/dict_8_46.webm","exp_vids/dict_8_47.webm","exp_vids/dict_8_48.webm"};
    View clickview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dict_8);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Dict_8_Activity.this,iv_back);
                stopvid();
                finish();
            }
        });
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_8_Activity.this,iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Dict_8_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_8_Activity.this,iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_8_Activity.this,iv_next);
                position += 1;
                    ...
                    if(position==strArray.length-1)
                    {
                        ...
                        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                tv_lastpage_text.setText("You Completed Dictionary Lesson 8");
                                ib_home.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        StaticValues.SavePreferences("Dict_8_Activity","YES",Dict_8_Activity.this);
                                        Intent intent = new Intent(Dict_8_Activity.this, Spell_12_Activity.class);
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Dict_8_Activity.this,iv_home);
                Intent i1 = new Intent(Dict_8_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
        ...
        imgbtn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Dict_8_Activity.this,imgbtn_prev);
                    if (position > 0) {
//                    stopvid();
                        position -= 1;
                       checkfileexists();
        ...
        imgbtn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Dict_8_Activity.this,imgbtn_home);
                    stopvid();
                    finish();
                }
            }
        ...
        btn_key_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_a);
                    if (position == 24) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                           checkfileexists();
                            ...
                            position -= 1;
                            Toast.makeText(Dict_8_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
                            stopvid();
                            Intent i = new Intent(Dict_8_Activity.this, Quiz1Activity.class);
                            startActivity(i);
                            //finish();
                        }
                    } else {
                        MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                        mPlayer2.start();
                    }
                }
            }
        ...
        btn_key_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_b);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_c);
                    if (position == 29) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_d);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_e.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_e);
                    if (position == 5||position == 16||position == 18||position == 26||position == 32||position == 38) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_f);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_g.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_g);
                    if (position == 2) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_h.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_h);
                    if (position == 23) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_i);
                    if (position == 3) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_j);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_k.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_k);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_l);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_m);
...
//                        stopvid();
        ...
        btn_key_n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_n);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_o);
...
//                        stopvid();
        ...
        btn_key_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_p);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_q);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_r);
                    if (position ==19) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_s);
                    if (position == 35) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_t);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_u.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_u);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_v);
                    if (position == 4||position == 17||position == 25) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_w.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_w);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_x);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_y.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_y);
                    if (position == 20) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
        ...
        btn_key_z.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Dict_8_Activity.this,btn_key_z);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Dict_8_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
    ...
    private void initializePlayer(int pos, List<Uri> urilist, List<String> mysound_list) {
        ...
        if (position == 2||position == 3||position == 4||position == 17||position == 25||position == 5||position == 16
                ||position == 18||position == 26||position == 32||position == 38||position == 19||position == 20||position == 23||position == 24
                ||position == 29||position == 30||position == 36||position == 31||position == 37||position == 35) {
...
//            }
//        });
        if(position==1||position==7||position==9||position==11||position==13||position==15||position==22||position==28||position==34)
        {
...
//                            startActivity(i);
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mediaPlayer) {
                    image_anim_last(Dict_8_Activity.this,iv_next);
                    iv_playpause.setImageResource(R.drawable.ic_play);
                }
            });
        }
    ...
    public void checkfileexists() {
            ...
            if (StaticValues.GetPreferences("Last_Open_position", Dict_8_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Dict_8_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Dict_8_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Dict_8_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Dict_8_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Dict_8_Activity", Dict_8_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Dictionary", Dict_8_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Dict_8_Activity.this);
    }
    @Override
