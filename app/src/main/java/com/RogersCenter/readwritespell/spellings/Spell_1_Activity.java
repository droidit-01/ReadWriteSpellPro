...
public class Spell_1_Activity extends AppCompatActivity {
    VideoView vv;
    ...
    String[] strArray = {"spell_1.webm","spell_2.webm","spell_3.webm","spell_4.webm","spell_5.webm","spell_6.webm",
            "spell_7.webm","spell_8.webm","spell_9.webm","spell_10.webm","spell_11.webm","spell_12.webm",
            "spell_13.webm","spell_14.webm","spell_15.webm","spell_16.webm","spell_17.webm","spell_18.webm",
            "spell_19.webm"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Spell_1_Activity.this,iv_back);
                stopvid();
                finish();
            }
        });
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_1_Activity.this,iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Spell_1_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_1_Activity.this,iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_1_Activity.this,iv_next);
                position += 1;
                   ...
                   checkfileexists();
                    ...
                    vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            Toast.makeText(Spell_1_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
//                            stopvid();
//                            Intent i = new Intent(Spell_1_Activity.this, Quiz1Activity.class);
//                            startActivity(i);
                            //finish();
                        }
                    });
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_1_Activity.this,iv_home);
                Intent i1 = new Intent(Spell_1_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
        ...
        imgbtn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Spell_1_Activity.this,imgbtn_prev);
                    if (position > 0) {
//                    stopvid();
                        position -= 1;
                       checkfileexists();
        ...
        imgbtn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Spell_1_Activity.this,imgbtn_home);
                    stopvid();
                    finish();
                }
            }
        ...
        btn_key_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_a);
                    if (position == 11) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
                        ...
                        MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                        mPlayer2.start();
                    }
                }
            }
        ...
        btn_key_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_b);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_c);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_d);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_e.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_e);
...
//                        stopvid();
        ...
        btn_key_f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_f);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_g.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_g);
                    if (position == 4||position==7||position==15) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_h.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_h);
                    if (position == 10) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_i);
                    if (position == 2) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_j);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_k.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_k);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_l);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_m);
...
//                        stopvid();
        ...
        btn_key_n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_n);
                    if (position == 3) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_o);
                    if (position == 5) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_p);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_q);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_r);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_s);
                    if (position == 17) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_t);
...
//                        stopvid();
        ...
        btn_key_u.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_u);
                    if (position == 16) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_v);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_w.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_w);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_x);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_y.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_y);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_z.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_1_Activity.this,btn_key_z);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Spell_1_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
...
//        });
        if (position == 0) {
            ...
            view_clicked.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!vv.isPlaying()) {
                        View_anim(Spell_1_Activity.this,view_clicked);
                        if (position == 0) {
                            position += 1;
                            if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        else if(position ==1)
        {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mediaPlayer) {
                    image_anim_last(Spell_1_Activity.this,iv_next);
                    iv_playpause.setImageResource(R.drawable.ic_play);
                }
            });
        }
        ...
        if(position==strArray.length-1)
        {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mediaPlayer) {
                    ...
                    tv_lastpage_text.setText("You Completed Spelling Lesson 1");
                    ib_home.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            StaticValues.SavePreferences("Spell_1_Activity","YES", Spell_1_Activity.this);
                            Intent intent = new Intent(Spell_1_Activity.this, Writing_Chapt4_Activity.class);
    ...
    public void checkfileexists() {
            if (StaticValues.GetPreferences("Last_Open_position", Spell_1_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Spell_1_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Spell_1_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Spell_1_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Spell_1_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Spell_1_Activity", Spell_1_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Spelling", Spell_1_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Spell_1_Activity.this);
    }
    @Override
