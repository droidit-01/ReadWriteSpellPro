...
public class Spell_10_Activity extends AppCompatActivity {
    ...
    String[] strArray = {"exp_vids/spell_10_1_s.webm","exp_vids/spell_10_2_u.webm","exp_vids/spell_10_3_n.webm","exp_vids/spell_10_4_d.webm","exp_vids/spell_10_5_a.webm","exp_vids/spell_10_6_y.webm",
            "exp_vids/spell_10_7_l.webm","exp_vids/spell_10_8_u.webm","exp_vids/spell_10_9_n.webm","exp_vids/spell_10_10_c.webm","exp_vids/spell_10_11_h.webm","exp_vids/spell_10_12_b.webm",
            "exp_vids/spell_10_13_r.webm","exp_vids/spell_10_14_u.webm","exp_vids/spell_10_15_s.webm","exp_vids/spell_10_16_h.webm","exp_vids/spell_10_17_g.webm","exp_vids/spell_10_18_l.webm",
            "exp_vids/spell_10_19_a.webm","exp_vids/spell_10_20_s.webm","exp_vids/spell_10_21_s.webm","exp_vids/spell_10_22_t.webm","exp_vids/spell_10_23_h.webm","exp_vids/spell_10_24_a.webm",
            "exp_vids/spell_10_25_n.webm","exp_vids/spell_10_26_k.webm","exp_vids/spell_10_27_b.webm","exp_vids/spell_10_28_o.webm","exp_vids/spell_10_29_x.webm","exp_vids/spell_10_30_e.webm",
            "exp_vids/spell_10_31_s.webm","exp_vids/spell_10_32.webm"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Spell_10_Activity.this, iv_back);
                stopvid();
                finish();
            }
        });
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_10_Activity.this, iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Spell_10_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_10_Activity.this, iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_10_Activity.this, iv_next);
                position += 1;
                   ...
                   checkfileexists();
                    ...
                    vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            Toast.makeText(Spell_10_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
//                            stopvid();
//                            Intent i = new Intent(Spell_10_Activity.this, Quiz1Activity.class);
//                            startActivity(i);
                            //finish();
                        }
                    });
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_10_Activity.this, iv_home);
                Intent i1 = new Intent(Spell_10_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
        ...
        imgbtn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Spell_10_Activity.this,imgbtn_prev);
                    if (position > 0) {
//                    stopvid();
                        position -= 1;
                       checkfileexists();
        ...
        imgbtn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Spell_10_Activity.this,imgbtn_home);
                    stopvid();
                    finish();
                }
            }
        ...
        btn_key_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_a);
                    if (position == 4 || position == 18|| position ==23) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
                           checkfileexists();
                        ...
                        MediaPlayer mPlayer2 = MediaPlayer.create(Spell_10_Activity.this, R.raw.tryagain);
                        mPlayer2.start();
                    }
                }
            }
        ...
        btn_key_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_b);
...
//                        stopvid();
        ...
        btn_key_c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_c);
                    if (position == 9) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_d);
                    if (position == 3) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_e.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_e);
                    if (position == 29) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_f);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_g.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_g);
                    if (position == 16) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_h.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_h);
                    if (position == 10 || position == 15|| position ==22) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_i);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_j);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_k.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_k);
                    if (position == 25) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_l);
...
//                        stopvid();
        ...
        btn_key_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_m);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_n);
                    if (position == 2 || position == 8|| position ==24) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_o);
                    if (position == 27) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_p);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_q);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_r);
                    if (position == 12) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_s);
                    if (position == 0 || position == 14 || position == 19 || position == 20
                            || position ==30) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_t);
                    if (position == 21) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_u.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_u);
...
//                        stopvid();
        ...
        btn_key_v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_v);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_w.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_w);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_x);
                    if (position == 28) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_y.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_y);
                    if (position == 5) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_z.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_10_Activity.this, btn_key_z);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
...
//        vv.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + urilist.get(pos)));
        ...
        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
                image_anim_last(Spell_10_Activity.this,iv_next);
                iv_playpause.setImageResource(R.drawable.ic_play);
            }
        });
        ...
        if(position==strArray.length-1)
        {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mediaPlayer) {
                    ...
                    tv_lastpage_text.setText("You Completed Spelling Lesson 10");
                    ib_home.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            StaticValues.SavePreferences("Spell_10_Activity","YES", Spell_10_Activity.this);
                            Intent intent = new Intent(Spell_10_Activity.this, Writing_Chapt13_Activity.class);
    ...
    public void checkfileexists() {
            ...
            if (StaticValues.GetPreferences("Last_Open_position", Spell_10_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Spell_10_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Spell_10_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Spell_10_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Spell_10_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Spell_1_Activity", Spell_10_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Spelling", Spell_10_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Spell_10_Activity.this);
    }
    @Override
