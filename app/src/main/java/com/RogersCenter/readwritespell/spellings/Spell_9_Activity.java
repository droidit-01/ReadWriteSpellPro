...
public class Spell_9_Activity extends AppCompatActivity {
    ...
    String[] strArray = {"exp_vids/spell_9_1_w.webm","exp_vids/spell_9_2_h.webm","exp_vids/spell_9_3_e.webm","exp_vids/spell_9_4_n.webm","exp_vids/spell_9_5_c.webm","exp_vids/spell_9_6_a.webm",
            "exp_vids/spell_9_7_s.webm","exp_vids/spell_9_8_h.webm","exp_vids/spell_9_9_s.webm","exp_vids/spell_9_10_h.webm","exp_vids/spell_9_11_e.webm","exp_vids/spell_9_12_c.webm",
            "exp_vids/spell_9_13_h.webm","exp_vids/spell_9_14_e.webm","exp_vids/spell_9_15_f.webm","exp_vids/spell_9_16_c.webm","exp_vids/spell_9_17_h.webm","exp_vids/spell_9_18_a.webm",
            "exp_vids/spell_9_19_o.webm","exp_vids/spell_9_20_s.webm","exp_vids/spell_9_21_b.webm","exp_vids/spell_9_22_a.webm","exp_vids/spell_9_23_t.webm","exp_vids/spell_9_24_h.webm",
            "exp_vids/spell_9_25.webm"};
      ...
      checkfileexists();
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Spell_9_Activity.this, iv_back);
                stopvid();
                finish();
            }
        });
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_9_Activity.this, iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                   checkfileexists();
                } else {
                    Toast.makeText(Spell_9_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_9_Activity.this, iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_9_Activity.this, iv_next);
                position += 1;
                   ...
                   checkfileexists();
                    ...
                    vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            Toast.makeText(Spell_9_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
//                            stopvid();
//                            Intent i = new Intent(Spell_9_Activity.this, Quiz1Activity.class);
//                            startActivity(i);
                            //finish();
                        }
                    });
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Spell_9_Activity.this, iv_home);
                Intent i1 = new Intent(Spell_9_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
        ...
        imgbtn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Spell_9_Activity.this,imgbtn_prev);
                    if (position > 0) {
//                    stopvid();
                        position -= 1;
                       checkfileexists();
        ...
        imgbtn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Spell_9_Activity.this,imgbtn_home);
                    stopvid();
                    finish();
                }
            }
        ...
        btn_key_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_a);
                    if (position == 5 || position == 17 || position == 21) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
                           checkfileexists();
                        ...
                        MediaPlayer mPlayer2 = MediaPlayer.create(Spell_9_Activity.this, R.raw.tryagain);
                        mPlayer2.start();
                    }
                }
            }
        ...
        btn_key_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_b);
                    if (position == 20) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_c);
                    if (position == 4 || position == 11 || position == 15) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_d);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_e.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_e);
                    if (position == 2 || position == 10 || position == 13) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_f);
                    if (position == 14) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_g.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_g);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_h.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_h);
                    if (position == 1 || position == 7 || position == 9 || position == 12
...
//                        stopvid();
        ...
        btn_key_i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_i);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_j);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_k.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_k);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_l);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_m);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_n);
                    if (position == 3) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_o);
                    if (position == 18) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_p);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_q);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_r);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_s);
                    if (position == 6 || position == 8 || position == 19) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
                           checkfileexists();
        ...
        btn_key_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_t);
                    if (position == 22) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_u.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_u);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_v);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_w.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_w);
                    if (position == 0) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_x);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_y.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_y);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
        ...
        btn_key_z.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Spell_9_Activity.this, btn_key_z);
                    if (position == 1000) {
                        position += 1;
                        if (position <= strArray.length - 1)  {
//                        stopvid();
...
//        vv.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + urilist.get(pos)));
        ...
        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
                image_anim_last(Spell_9_Activity.this,iv_next);
                iv_playpause.setImageResource(R.drawable.ic_play);
            }
        });
        ...
        if(position==strArray.length-1)
        {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mediaPlayer) {
                    ...
                    tv_lastpage_text.setText("You Completed Spelling Lesson 9");
                    ib_home.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            StaticValues.SavePreferences("Spell_9_Activity","YES", Spell_9_Activity.this);
                            Intent intent = new Intent(Spell_9_Activity.this, Writing_Chapt12_Activity.class);
    ...
    public void checkfileexists() {
            ...
            if (StaticValues.GetPreferences("Last_Open_position", Spell_9_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Spell_9_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Spell_9_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Spell_9_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Spell_9_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Spell_9_Activity", Spell_9_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Spelling", Spell_9_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Spell_9_Activity.this);
    }
    @Override
