...
public class Letter_DF_Activity extends AppCompatActivity {
    VideoView vv;
    ...
    String[] strArray = {"exp_vids/ltr_d_1.webm", "exp_vids/ltr_d_2.webm", "exp_vids/ltr_d_3.webm", "exp_vids/ltr_d_4.webm", "exp_vids/ltr_d_5.webm", "exp_vids/ltr_d_6.webm", "exp_vids/ltr_d_7.webm",
            "exp_vids/ltr_d_8.webm", "exp_vids/ltr_f_1.webm", "exp_vids/ltr_f_2.webm", "exp_vids/ltr_f_3.webm", "exp_vids/ltr_f_4.webm", "exp_vids/ltr_f_5.webm", "exp_vids/ltr_f_6.webm", "exp_vids/ltr_f_7.webm",
            "exp_vids/ltr_game_df_1.webm", "exp_vids/ltr_game_df_2.webm", "exp_vids/ltr_game_df_3.webm", "exp_vids/ltr_game_df_4.webm", "exp_vids/ltr_game_df_5.webm", "exp_vids/ltr_game_df_6.webm",
            "exp_vids/ltr_game_df_7.webm", "exp_vids/ltr_game_df_8.webm", "exp_vids/ltr_game_df_9.webm", "exp_vids/ltr_game_df_10.webm", "exp_vids/ltr_game_df_11.webm", "exp_vids/ltr_game_df_12.webm",
            "exp_vids/ltr_game_df_13.webm"};
    private ProgressDialog progressDoalog1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_letter_d_f);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Letter_DF_Activity.this, iv_back);
                stopvid();
                finish();
            }
        });
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Letter_DF_Activity.this, iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                    checkfileexists();
                } else {
                    Toast.makeText(Letter_DF_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Letter_DF_Activity.this, iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Letter_DF_Activity.this, iv_next);
                position += 1;
                if (position <= strArray.length - 1) {
                    ...
                    vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            Toast.makeText(Letter_DF_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
//                            stopvid();
//                            Intent i = new Intent(Letter_DF_Activity.this, Quiz1Activity.class);
//                            startActivity(i);
//                            finish();
                        }
                    });
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Letter_DF_Activity.this, iv_home);
                Intent i1 = new Intent(Letter_DF_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
        ...
        imgbtn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Letter_DF_Activity.this, imgbtn_prev);
                    if (position > 0) {
//                    stopvid();
                        position -= 1;
                        checkfileexists();
        ...
        imgbtn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Letter_DF_Activity.this, imgbtn_home);
                    stopvid();
                    finish();
                }
            }
        ...
        btn_key_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_a);
...
//                        stopvid();
                        ...
                        MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                        mPlayer2.start();
                    }
                }
            }
        ...
        btn_key_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_b);
...
//                        stopvid();
        ...
        btn_key_c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_c);
...
//                        stopvid();
        ...
        btn_key_d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_d);
                    if (position == 15) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
...
//                        stopvid();
                        ...
                        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                tv_lastpage_text.setText("You Completed Letter Lesson 2");
                                ib_home.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        StaticValues.SavePreferences("Letter_DF_Activity","YES", Letter_DF_Activity.this);
                                        Intent intent = new Intent(Letter_DF_Activity.this, Letter_MGT_Activity.class);
        ...
        btn_key_e.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_e);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_f);
                    if (position == 20 || position == 23) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                            checkfileexists();
        ...
        btn_key_g.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_g);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_h.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_h);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_i);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_j);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_k.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_k);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_l);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_m);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_n);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_o);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_p);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_q);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_r);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_s);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_t);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_u.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_u);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_v);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_w.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_w);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_x);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_y.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_y);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_z.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_DF_Activity.this, btn_key_z);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_DF_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
...
//        vv.setVideoURI(urilist.get(pos));
        ...
        if (position >= 15) {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mediaPlayer) {
                    image_anim_last(Letter_DF_Activity.this, iv_next);
                    iv_playpause.setImageResource(R.drawable.ic_play);
                }
            });
    ...
    public void checkfileexists() {
            if (StaticValues.GetPreferences("Last_Open_position", Letter_DF_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Letter_DF_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Letter_DF_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Letter_DF_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Letter_DF_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Letter_DF_Activity", Letter_DF_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Letters", Letter_DF_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Letter_DF_Activity.this);
    }
