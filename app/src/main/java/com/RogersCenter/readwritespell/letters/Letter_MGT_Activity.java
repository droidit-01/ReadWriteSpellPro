...
public class Letter_MGT_Activity extends AppCompatActivity {
    ...
    String[] strArray = {"exp_vids/ltr_m_1.webm", "exp_vids/ltr_m_2.webm", "exp_vids/ltr_m_3.webm", "exp_vids/ltr_m_4.webm", "exp_vids/ltr_m_5.webm", "exp_vids/ltr_m_6.webm", "exp_vids/ltr_m_7.webm",
            "exp_vids/ltr_g_1.webm", "exp_vids/ltr_g_2.webm", "exp_vids/ltr_g_3.webm", "exp_vids/ltr_g_4.webm", "exp_vids/ltr_g_5.webm", "exp_vids/ltr_g_6.webm", "exp_vids/ltr_g_7.webm",
            "exp_vids/ltr_t_1.webm", "exp_vids/ltr_t_2.webm", "exp_vids/ltr_t_3.webm", "exp_vids/ltr_t_4.webm", "exp_vids/ltr_t_5.webm", "exp_vids/ltr_t_6.webm", "exp_vids/ltr_t_7.webm",
            "exp_vids/ltr_game_mgt_1.webm", "exp_vids/ltr_game_mgt_2.webm", "exp_vids/ltr_game_mgt_3.webm", "exp_vids/ltr_game_mgt_4.webm", "exp_vids/ltr_game_mgt_5.webm", "exp_vids/ltr_game_mgt_6.webm",
            "exp_vids/ltr_game_mgt_7.webm", "exp_vids/ltr_game_mgt_8.webm", "exp_vids/ltr_game_mgt_9.webm", "exp_vids/ltr_game_mgt_10.webm", "exp_vids/ltr_game_mgt_11.webm", "exp_vids/ltr_game_mgt_12.webm",
            "exp_vids/ltr_game_mgt_13.webm", "exp_vids/ltr_game_mgt_14.webm", "exp_vids/ltr_game_mgt_15.webm", "exp_vids/ltr_game_mgt_16.webm", "exp_vids/ltr_game_mgt_17.webm", "exp_vids/ltr_game_mgt_18.webm"};
    private ProgressDialog progressDoalog1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_letter_m_g_t);
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                image_anim(Letter_MGT_Activity.this, iv_back);
                stopvid();
                finish();
            }
        });
        iv_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Letter_MGT_Activity.this, iv_previous);
                if (position > 0) {
//                    stopvid();
                    position -= 1;
                    checkfileexists();
                } else {
                    Toast.makeText(Letter_MGT_Activity.this, "This is first video", Toast.LENGTH_SHORT).show();
                }
            }
        });
        iv_playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Letter_MGT_Activity.this, iv_playpause);
                if (vv.isPlaying()) {
                    pausePlayer();
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Letter_MGT_Activity.this, iv_next);
                position += 1;
                if (position <= strArray.length - 1) {
                    ...
                    vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            Toast.makeText(Letter_MGT_Activity.this, "This is last video", Toast.LENGTH_SHORT).show();
//                            stopvid();
//                            Intent i = new Intent(Letter_MGT_Activity.this, Quiz1Activity.class);
//                            startActivity(i);
//                            //finish();
                        }
                    });
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                image_anim(Letter_MGT_Activity.this, iv_home);
                Intent i1 = new Intent(Letter_MGT_Activity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
        ...
        imgbtn_prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Letter_MGT_Activity.this, imgbtn_prev);
                    if (position > 0) {
//                    stopvid();
                        position -= 1;
                        checkfileexists();
        ...
        imgbtn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_imgbutton_anim(Letter_MGT_Activity.this, imgbtn_home);
                    stopvid();
                    finish();
                }
            }
        ...
        btn_key_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_a);
                    if (position == 24 || position == 36) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                            checkfileexists();
                        ...
                        MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                        mPlayer2.start();
                    }
                }
            }
        ...
        btn_key_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_b);
...
//                        stopvid();
        ...
        btn_key_c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_c);
                    if (position == 25) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
...
//                        stopvid();
                        ...
                        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                tv_lastpage_text.setText("You Completed Letter Lesson 3");
                                ib_home.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        StaticValues.SavePreferences("Letter_MGT_Activity","YES", Letter_MGT_Activity.this);
                                        Intent intent = new Intent(Letter_MGT_Activity.this, Letter_HE_Activity.class);
        ...
        btn_key_d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_d);
...
//                        stopvid();
        ...
        btn_key_e.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_e);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_f);
...
//                        stopvid();
        ...
        btn_key_g.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_g);
...
//                        stopvid();
        ...
        btn_key_h.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_h);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_i);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_j);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_k.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_k);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_l);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_m);
                    if (position == 23 || position == 35) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                            checkfileexists();
        ...
        btn_key_n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_n);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_o);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_p);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_q.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_q);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_r.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_r);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_s);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_t);
                    if (position == 27 || position == 34) {
                        position += 1;
                        if (position <= strArray.length - 1) {
//                        stopvid();
                            checkfileexists();
        ...
        btn_key_u.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_u);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_v);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_w.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_w);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_x);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_y.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_y);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
        ...
        btn_key_z.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!vv.isPlaying()) {
                    keyboard_button_anim(Letter_MGT_Activity.this, btn_key_z);
                    MediaPlayer mPlayer2 = MediaPlayer.create(Letter_MGT_Activity.this, R.raw.tryagain);
                    mPlayer2.start();
                }
            }
...
//        vv.setVideoURI(urilist.get(pos));
        ...
        if (position >= 21) {
            ...
            vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mediaPlayer) {
                    image_anim_last(Letter_MGT_Activity.this, iv_next);
                    iv_playpause.setImageResource(R.drawable.ic_play);
                }
            });
        }
    ...
    public void checkfileexists() {
            if (StaticValues.GetPreferences("Last_Open_position", Letter_MGT_Activity.this) != null) {
                position = Integer.parseInt(StaticValues.GetPreferences("Last_Open_position", Letter_MGT_Activity.this));
                Log.d("LASTPOS", "" + position);
                StaticValues.RemovePreferences("Last_Open_position", Letter_MGT_Activity.this);
                StaticValues.RemovePreferences("Last_Open_Lesson", Letter_MGT_Activity.this);
                StaticValues.RemovePreferences("Last_Open_ParentLesson", Letter_MGT_Activity.this);
            }
...
//        player.getPlaybackState();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        stopvid();
        StaticValues.SavePreferences("Last_Open_Lesson", "Letter_MGT_Activity", Letter_MGT_Activity.this);
        StaticValues.SavePreferences("Last_Open_ParentLesson", "Letters", Letter_MGT_Activity.this);
        StaticValues.SavePreferences("Last_Open_position", "" + position, Letter_MGT_Activity.this);
    }
    @Override
